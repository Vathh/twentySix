...
@section('content')
    <div class="container mx-auto py-8">
        ...
        <div class="mb-8 bg-lighter-bg p-6 rounded-lg shadow">
            <h2 class="text-xl font-semibold text-light-orange mb-4">Administratorzy ligi</h2>
            @if(empty($admins))
        ...
        <h2 class="text-2xl text-light-green text-center mb-7">Użytkownicy powiązani z ligą</h2>

        @if($relatedUsers->isEmpty())
            <p class="text-light-white text-center">Brak użytkowników powiązanych z ligą.</p>
        @else
            <div class="flex flex-wrap gap-3">
