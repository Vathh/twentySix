...
const MATCH_STATE_EVENTS = ['match.state', '.match.state'];
...
document.addEventListener('alpine:init', () => {
    Alpine.data('matchLiveViewer', (config) => ({
        ...
        connectWebSocket(cfg) {
            ...
            MATCH_STATE_EVENTS.forEach((eventName) => {
        ...
        get isLive() {
            return this.state?.match?.status === 'in_progress';
        },

        get isFinished() {
            return this.state?.match?.status === 'finished';
        },
